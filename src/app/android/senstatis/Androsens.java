...
public class Androsens extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pb_orientationA = (ProgressBar) this.findViewById(R.id.ProgressBar_oriA);
        tv_orientationB = (TextView) this.findViewById(R.id.TextView_oriB);
        pb_orientationB = (ProgressBar) this.findViewById(R.id.ProgressBar_oriB);
        tv_orientationC = (TextView) this.findViewById(R.id.TextView_oriC);
        pb_orientationC = (ProgressBar) this.findViewById(R.id.ProgressBar_oriC);
        tv_accelA = (TextView) this.findViewById(R.id.TextView_accA);
        pb_accelA = (ProgressBar) this.findViewById(R.id.ProgressBar_accA);
        tv_accelB = (TextView) this.findViewById(R.id.TextView_accB);
        pb_accelB = (ProgressBar) this.findViewById(R.id.ProgressBar_accB);
        tv_accelC = (TextView) this.findViewById(R.id.TextView_accC);
        pb_accelC = (ProgressBar) this.findViewById(R.id.ProgressBar_accC);
        tv_magneticA = (TextView) this.findViewById(R.id.TextView_magA);
        pb_magneticA = (ProgressBar) this.findViewById(R.id.ProgressBar_magA);
        tv_magneticB = (TextView) this.findViewById(R.id.TextView_magB);
        pb_magneticB = (ProgressBar) this.findViewById(R.id.ProgressBar_magB);
        tv_magneticC = (TextView) this.findViewById(R.id.TextView_magC);
        pb_magneticC = (ProgressBar) this.findViewById(R.id.ProgressBar_magC);
        tv_lightA = (TextView) this.findViewById(R.id.TextView_ligA);
        pb_lightA = (ProgressBar) this.findViewById(R.id.ProgressBar_ligA);
        tv_proxA = (TextView) this.findViewById(R.id.TextView_proxA);
        pb_proxA = (ProgressBar) this.findViewById(R.id.ProgressBar_proxA);
        tv_presA = (TextView) this.findViewById(R.id.TextView_presA);
        pb_presA = (ProgressBar) this.findViewById(R.id.ProgressBar_presA);
        tv_tempA = (TextView) this.findViewById(R.id.TextView_tempA);
    ...
    protected String getSensorInfo(Sensor sen) {
        ...
        switch (sen.getType()) {
            ...
            case Sensor.TYPE_TEMPERATURE:
                snsType = "TYPE_AMBIENT_TEMPERATURE";
                break;
            default:
